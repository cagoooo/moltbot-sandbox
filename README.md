...
這個 repository 收錄 **moltbot-sandbox** 專案的原始碼與相關資源。以下資訊依目前檔案結構整理；實際行為仍以程式碼與部署設定為準。

- 專案定位：實用工具／自動化原型
- Repository：`cagoooo/moltbot-sandbox`
- 可見性：公開
- 主要技術：TypeScript、React、Vite、Cloudflare Workers、Docker
